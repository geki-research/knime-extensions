...
On this branch no -P is needed: the knime-5.8 profile is
active by default and resolves against
https://update.knime.com/analytics-platform/5.8
...
You are on releases/5.8, pinned to the KNIME 5.8 update site
